...
interface GenomeInterface
{
	 ...
	 * @param int $activationFunction The index of the activation function of the node.
	 * @param int $aggregationFunction The index of the aggregation function of the node.
